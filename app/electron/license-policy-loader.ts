...
// loaded here via loadBundledCjs('license-policy'), mirroring
// ./ipc/engine-loader.ts and ./scene-inspector-loader.ts.

import { loadBundledCjs } from './bundled-cjs-loader';
...
export function loadLicensePolicy(): Policy {
  return loadBundledCjs<Policy>('license-policy');
}
