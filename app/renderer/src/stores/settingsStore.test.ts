    ...
    const mock = createMockSoundBuddy({
      getSettings: async () => {
        ...
        return {
          ...
          channelLabels: {}, channelGroups: {}, inputInstrumentProfiles: {}, crashReportingEnabled: true, dawWorkspaceEnabled: false, liveAdjustmentsEnabled: false, reportFirstUxEnabled: false, shareChurchName: '', weeklyReminderEnabled: false, weeklyReminderServiceDay: 0, liveEqPaneWidth: 360, secondaryMeasurementEnabled: false, measurementDeviceName: '', gradingProfile: 'casual' as const, consoleNetworkConsentGranted: false,
        };
      },
    });
    const store = createSettingsStore(() => mock.api);
