...
(#867) — and the checkout is up to date with it (HEAD df93362 ==
...
Four prior verification-only passes for this exact feature are already
recorded as ADR-0041, ADR-0042, ADR-0048, and ADR-0054 (PR #913). A
...
checkout's HEAD (#862 as ADR-0055, #863 as ADR-0050, #864 as ADR-0051).
...
diff is the correct outcome. Record ADR-0056 documenting the
verification-only re-run; ADR-0038 (the #861 design decision) and
ADR-0041/0042/0048/0054 (the prior passes) are already recorded and must
not be duplicated or amended.
...
convention (ADR-0025/0026/0032-0055, including this seam's own
ADR-0041/0042/0048/0054) is continued. Negative: if a gate fails on an
...
- [ADR-0041 — Report-card rule-narrative renderers self-register ships as a verification-only pass because the feature already landed](docs/adr/0041-report-card-rule-narrative-renderers-self-register-ships-as-a-verification-only-pass-because-the-feature-already-landed.md)
