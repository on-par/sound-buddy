...
/** electron-updater's standard macOS update-info manifest, generated by electron-builder (#625). */
export const ELECTRON_UPDATER_MANIFEST_FILENAME = 'latest-mac.yml';
