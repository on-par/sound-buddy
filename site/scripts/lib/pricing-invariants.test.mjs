...
const countdownPresentHtml = `
  <div id="pricing">
    <div class="founding-countdown" data-drop-deadline="2026-07-24T17:00:00.000Z">
      <p class="fc-copy">Founding pricing locks with the demo video drop — <strong data-fc-remaining>4d 21h 3m left</strong> to claim one of 10.</p>
    </div>
  </div>
`;
...
const countdownAbsentHtml = `
  <div id="pricing">
    <div class="founding-cap">
      <p class="fc-copy">Limited to 10 founding licenses — one-time $199, then Founding closes.</p>
    </div>
  </div>
`;
...
describe('checkFoundingUrgencyInvariants', () => {
  ...
  it('no problems for a countdown-absent fixture that still says 10', () => {
  ...
  it('flags a countdown-absent fixture that leaks data-fc-remaining', () => {
    const html = `
      <div id="pricing">
        <div class="founding-cap">
          <p class="fc-copy">Limited to 10 founding licenses.</p>
  ...
  it('flags a countdown-absent fixture with no 10', () => {
